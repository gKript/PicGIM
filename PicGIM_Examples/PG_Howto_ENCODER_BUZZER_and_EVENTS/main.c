...
/*
	...
	In this example we analyze how to configure PicGIM and how to write the right code using the ENCODER modules with external EVENTS
	to the correct input of direction, pulse and switch.
	...
	In this example we filled out the necessary fields in this way:
			...
			#define PG_PROJECT_NAME						ENCODER_BUZZER_and_EVENTS		//!< The name of your Project
	...
	This example requires the presence of the ENCODER, BUZZER and EVENTS module.
	To operate the BUZZER and the ENCODER module needs the DELAY module.
