...
*/
	...
	#define PG_PROJECT_DATE						01/01/2019				//!< Date of the project
	...
	#define PG_USER_SUPPLY_VOLT					5.00					//!< The power supply VOLTAGE of the MCU in your project. Unit of measure is expressed in [V].
