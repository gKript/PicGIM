//GCP - General Communication Protocol
	...
	#define _PGIM_GCP_SETUP_PUBLIC_H_
		...
		//		R X   B Y T E
		//-------------------------------------------------------------------------------------------------------------
		#define	PG_GCP_TIMEOUT_MS								20000		//!< Min. 1ms - Max. 60000ms || 0 = Streaming
		
		//-------------------------------------------------------------------------------------------------------------
		//		C R C
		//-------------------------------------------------------------------------------------------------------------
		#define PG_GCP_CRC_ENABLE								PG_ENABLE	//!< Must be: PG_ENABLE  ||  PG_DISABLE
		#define PG_GCP_CRC_TIMEOUT_MS							30000		//!< Min. 1ms - Max. 60000ms || 0 = Streaming
		...
		#define PG_GCP_BUFFER_RX_01_LENGTH						3			//!< Min. 1 - Max. xxxxxx >
