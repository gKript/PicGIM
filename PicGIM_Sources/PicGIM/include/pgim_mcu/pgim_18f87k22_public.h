/*
	...
	File name :		pgim_18f87k22_public.h
	...
	See also related :		pgim_18f87k22.h
...
#ifndef _PGIM_18F87K22_PUBLIC_H_
	#define _PGIM_18F87K22_PUBLIC_H_

	#ifdef	_GIM_H_
		#ifdef _PGIM_18F87K22_PRIVATE_H_
		
			/** CONFIGURATION **************************************************/
			
			//---[ Fuses ]---
			#if ( PG_USE_INTERNAL_OSC == PG_DISABLE )
				#pragma config FOSC				= EC3  		// Used only with external oscillator
			#endif
		...
		#endif
	#endif
#endif /* _PGIM_18F87K22_PUBLIC_H_ */
