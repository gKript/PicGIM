/*
	...
	File name :		pgim_18f97j60_public.h
	...
	See also related :		pgim_18f97j60.h
 ...
 */
 ...
 /*!
		\file		pgim_18f97j60_public.h
		\version	0.5-0
		\date		2002 - 2015
		\brief		The public configuration file for the 18F97j60 uController.
...
#ifndef _PGIM_18F97J60_PUBLIC_H_
	#define _PGIM_18F97J60_PUBLIC_H_

	#ifdef	_GIM_H_
		#ifdef _PGIM_18F97J60_PRIVATE_H_
		
			/** CONFIGURATION **************************************************/
			
			#if ( PG_USE_INTERNAL_OSC == PG_DISABLE )
				#pragma	config FOSC			= HSPLL	//correggere!!!		// Used only with external oscillator
				#pragma	config FOSC2		= OFF  	//correggere!!!		// Used only with external oscillator
			#endif
/*			
