...
//	-------- External Interrupts ----------------------------------------------------------------
	...
	#define PG_INTERRUPT_INT1			PG_ENABLE			// PG_ENABLE	PG_DISABLE
	#define PG_INTERRUPT_INT2			PG_ENABLE			// PG_ENABLE	PG_DISABLE
	#define PG_INTERRUPT_RB0			PG_DISABLE			// PG_ENABLE	PG_DISABLE

//	-------- Internal Interrupts ----------------------------------------------------------------
	
	#define PG_INTERRUPT_TMR0			PG_ENABLE			// PG_ENABLE	PG_DISABLE
	#define PG_INTERRUPT_TMR1			PG_ENABLE			// PG_ENABLE	PG_DISABLE
